...
namespace SwishApiTester.Helpers
{
    public class VisitorLogHelper
    {
        /// <summary>
        /// Funktion som loggar till databasen alla anrop som görs för att ha lite statisitk på antal personer som går in på SwishApiTester.se
        /// </summary>
        public static void Log()
        {
            try
            {
                // Denna funktion ska endast köras om projektet är satt i publik website läget = körs på SwishApiTester.se
