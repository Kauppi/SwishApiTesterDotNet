...
namespace Client
{
    ...
    public class SwishClient
    {
        ...
        //private const string PaymentPath = "https://mss.cpc.getswish.net/swish-cpcapi/api/v1/paymentrequests/";
        //private const string RefundPath = "https://mss.cpc.getswish.net/swish-cpcapi/api/v1/refunds";
        ...
        private SwishApiResponse ExtractSwishResponse(HttpResponseMessage responseMessage)
        {
            ...
            if (location != null)
            {
                ...
                swishResponse.Id = id;
                swishResponse.PaymentRequestToken = id;
                swishResponse.Error = "";
            }
